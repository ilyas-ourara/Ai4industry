...
Provides interface to LLM services (Ollama, OpenAI).
"""
...
class OllamaLLMService(LLMService):
    ...
    def chat(
        ...
        try:
            ...
            self._logger.info(f"Sending request to Ollama ({self.model})...")
...
def get_llm_service(
    ...
    **kwargs
    ...
    Args:
        service_type: Type of service ('ollama', 'openai', 'mock')
