...
class GraphBuilder:
    ...
    def __init__(self, name: str = "RAG Workflow"):
        ...
        # Initialize state graph with AgentState
    ...
    def add_conditional_edge(
        ...
        Returns:
            Self for chaining
        """
        # Convert END strings in path_map
        resolved_map = {
...
def build_full_rag_graph(with_checkpointing: bool = False):
    ...
    # Add edges for the full pipeline
    builder.add_edge("extraction", "context_construction")
    
    # Conditional: proceed to search only if query exists
    ...
    # Conditional: proceed to synthesis only if search has results
    builder.add_conditional_edge(
        "search",
        should_continue_to_synthesis,
    ...
    # Build with optional checkpointing
