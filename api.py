...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Determine LLM service type from environment
        ...
        if rag_workflow.load_existing_index():
            ...
            logger.warning("⚠️ No existing index found. Please index documents first.")
...
async def search_documents(request: SearchRequest):
    ...
    try:
        # Access the context agent for direct search
